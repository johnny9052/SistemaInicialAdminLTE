...
--
-- Base de datos: `sistema_inicial_adminlte`
--
CREATE DATABASE IF NOT EXISTS `sistema_inicial_adminlte` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `sistema_inicial_adminlte`;
